...
class Predmeti extends CI_Controller {
    ...
    public function overview($predmetId = 0) {
        ...
        $data['modul'] = 'profesor/moduls/predmeti/predmet_overview';
    ...
    function add() {
        ...
        $data['modul'] = 'profesor/moduls/predmeti/predmeti_add_form';
    ...
    function index($offset = 0) {
        ...
        if (isset($_GET['json'])) {
            ...
            $this->datatables->select('predmetId, predmetName, predmetStatus')->from('predmeti')->where('predmetStatus != \'deleted\'')->where('predmetProfesorId', $this->profesor->profesorId);
            $actions = '<a class="button small no-padding blue" style="line-height:0 !important; padding-left: 5px;padding-right: 5px;" href="' . base_url() . 'profesor/predmeti/edit/$1">Измени</a> | <a class="button small no-padding red" style="line-height:0 !important;padding-left: 5px;padding-right: 5px;" href="' . base_url() . 'profesor/predmeti/delete/$1">Избриши</a>';
        ...
        $data['modul'] = 'profesor/moduls/predmeti/predmeti_index';
    ...
    function edit($predmetId = 0) {
       ...
       $this->form_validation->set_rules('predmetName', 'Име', 'trim|required');
        ...
        $data['modul'] = 'profesor/moduls/predmeti/predmeti_edit_form';
        $this->load->view('profesor/template', $data);
    }
